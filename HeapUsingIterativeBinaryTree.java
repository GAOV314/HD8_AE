...
/**
 * Represents a heap implemented using an iterative binary tree.
 *
...
public class HeapUsingIterativeBinaryTree<P, V> implements IHeap<P, V> {
    ...
    /**
     * Constructs a HeapUsingIterativeBinaryTree with the specified priority comparator.
     *
     * @param priorityComparator The comparator used to determine the priority of elements in the heap.
     */
    ...
    /**
     * Performs a swap operation between a node and its parent if necessary to maintain the heap property.
     *
     * @param actualNode The node to be swapped if necessary.
     */
